describe('The mostProfitableDepartment function', function(){
    it('determined that the Most profitable department is "outdoor" for dataset 1', function(){
        var salesData = [
    ...
    it('determined that the Most profitable department is "electronics" for dataset 2', function(){
        var salesData = [
            {department : 'hardware', sales : 4500, day : 'Monday'},
            {department : 'outdoor', sales : 1500, day : 'Monday'},
            {department : 'carpentry', sales : 5500, day : 'Monday'},
    ...
    it('determined that the Most profitable day is "Thursday" for dataset 1', function(){  
        var salesData = [
            {department : 'hardware', sales : 4500, day : 'Monday'},
            {department : 'outdoor', sales : 1500, day : 'Monday'},
            {department : 'carpentry', sales : 5500, day : 'Monday'},
    ...
    it('determined that the Most profitable day is "Wednesday" for dataset 2', function(){
        var salesData = [
            {department : 'hardware', sales : 4500, day : 'Monday'},
            {department : 'outdoor', sales : 1500, day : 'Monday'},
            {department : 'carpentry', sales : 5500, day : 'Monday'},
